...
def get_parser():
    ...
    p.add_argument("hq_fastq",
                   help="Exported FASTQ containing high-quality transcripts")
    p.add_argument("lq_fastq",
                   help="Exported FASTQ containing low-quality transcripts")
    return p
