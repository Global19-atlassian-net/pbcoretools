...
def _get_parser():
    ...
    p.add_argument("lima_datastore", help="Datastore json generated by lima to demultiplex input_reads.")
    p.add_argument("barcodes", help="BarcodeSet lima used to demultiplex reads")
