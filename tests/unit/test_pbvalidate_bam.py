...
@RG\tID:%(rg_id)s%(pl)s\tDS:READTYPE=SUBREAD;DeletionQV=dq;DeletionTag=dt;InsertionQV=iq;MergeQV=mq;SubstitutionQV=sq;%(ipd)s=ip;FRAMERATEHZ=80.0;BASECALLERVERSION=%(bcv)s;%(fr)sBINDINGKIT=%(bk)s;SEQUENCINGKIT=%(sk)s\tPU:movie1
...
unmapped_sam_str_ = """\
@HD\tVN:1.5\tSO:%(so)s\tpb:3.0.1
@RG\tID:b5482b33\tPL:%(pl)s\tDS:READTYPE=SUBREAD;DeletionQV=dq;DeletionTag=dt;InsertionQV=iq;MergeQV=mq;SubstitutionQV=sq;%(ipd)s=ip;BINDINGKIT=100356300;SEQUENCINGKIT=100356200;FRAMERATEHZ=80.0;BASECALLERVERSION=%(bcv)s;FRAMERATEHZ=75.000000\tPU:m140906_231018_42161_c100676332550000001823129611271486_s1_p0
@PG\tID:bax2bam-0.0.2\tPN:bax2bam\tVN:0.0.2\tDS:bax2bam converts the legacy PacBio basecall format (bax.h5) into the BAM basecall format.\tCL:bax2bam in.bax.h5 out.bam
